...
* 1/ オート: 「プロジェクト依存関係」ツールを使用する（[4D 20 R6](https://blog.4d.com/ja/integrate-4d-components-directly-from-github/)以降）

* 2/ マニュアル: プロジェクトの`Components`フォルダーに4D_Info_Reportコンポーネントをコピーする（すべてのバージョン）
