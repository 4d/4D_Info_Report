...
This page is a compact index for legacy release navigation.

For the complete and detailed download list by version status, use:
- [DOWNLOAD](DOWNLOAD.md)

For per-file counters and visibility on adoption, use:
- [STATS](STATS.md)

For installation and usage details on legacy/manual setups, use:
